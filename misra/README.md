...
| Dir  |                                                              |              |                                                              |          |
| ---- | ------------------------------------------------------------ | ------------ | ------------------------------------------------------------ | -------- |
| D4.1 | Run-time failures shall be minimized. (\|, &, ~, <<, >>)     | incompatible | Embedded drivers need this method to set or clear some bits and drivers guarantee the safety of the operation. | very low |
...
Detailed reports can be found in /misra/ds18b20_polyspace_report.pdf.
